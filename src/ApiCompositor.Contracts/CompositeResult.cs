...
/// </summary>
[Serializable]
public class CompositeResult : DynamicObject
{
    /// <summary>
    ...
    private Dictionary<string, object> _errors = new Dictionary<string, object>();

    public bool AddError(string name, object value)
    {
        return _errors.TryAdd(name, value);
    }
    ...
    public CompositeResult(object instance)
    {
        Initialize(instance);
    }
